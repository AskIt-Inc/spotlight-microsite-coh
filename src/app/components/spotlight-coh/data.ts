...
export const clinicians: Clinician[] = [
  ...
  },
  {
    ...
    credentials: 'MD',
    title: 'Assistant Clinical Professor, Department of Medicine',
    specialty: 'Neurology · Clinical Neurophysiology · Neuromuscular Disorders',
    type: 'Medical Doctor',
    photo: '',
    bio: 'Hadi Mohammad Khanli, M.D., pursued neurology after witnessing his grandmother\'s struggle with Alzheimer\'s disease. Trained in Iran and the U.S., he completed neurology residencies, research at UCLA, and a clinical neurophysiology fellowship at NIH. He has published extensively and specializes in patient-centered neurological care.',
    hasVideo: false,
    hasSession: false,
    sessionDate: '',
    sessionTitle: '',
