...
export const clinicians: Clinician[] = [
  {
    ...
    specialty: 'Director of the COH Amyloidosis Program, caring for patients with all forms of amyloidosis — AL, TTR, AA, and LECT2 — alongside multiple myeloma and related plasma cell disorders.',
    type: 'Medical Doctor',
  ...
  },
  {
    ...
    specialty: 'Hematologist specialising in multiple myeloma, amyloidosis, and smoldering myeloma, with a focus on precision medicine and CAR T-cell therapy. Principal investigator of the SAVE trial for earlier AL amyloidosis diagnosis.',
    type: 'Medical Doctor',
  ...
  },
  {
    ...
    specialty: 'Hematologist-oncologist specialising in plasma cell disorders, multiple myeloma, and amyloidosis. Previously at Fred Hutchinson Cancer Research Center; principal investigator on seven active clinical trials at City of Hope.',
    type: 'Medical Doctor',
  ...
  },
  {
    ...
    name: 'Dr. Faizi Jamal',
    credentials: 'MD',
    title: 'Chief, Division of Cardiology · Director, Echocardiography Laboratory',
    specialty: 'Cardiologist and Chief of the Division of Cardiology, specialising in cardiac amyloidosis, heart failure, and advanced cardiac imaging. Director of the COH Echocardiography Laboratory.',
    type: 'Medical Doctor',
  ...
  },
  {
    ...
    specialty: 'Chief of Hematology at COH Phoenix, with expertise in acute leukemia, stem cell transplantation, and amyloidosis. Harvard/MGH-trained; co-founder of the Utah Amyloidosis Program at Huntsman Cancer Institute.',
    type: 'Medical Doctor',
