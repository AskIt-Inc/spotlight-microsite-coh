...
export const supportStaff: SupportStaff[] = [
  {
    ...
    credentials: 'BSN, RN',
    role: 'Clinical Nurse III, Hematology HP 410',
  ...
  },
  {
    ...
    role: 'Advanced Practice Provider, Hematology & HCT - Division of Multiple Myeloma & Amyloidosis',
  ...
  },
  {
    ...
    name: 'Edelyn Yhip',
    credentials: 'RN, BSN',
    role: 'Supervisor Intake Nurse Navigation, Enterprise New Patient Services',
    email: 'eyhip@coh.org',
    note: 'Edelyn Yhip supports intake nurse navigation for leukemia, lymphoma, myeloma, gene therapy, pediatrics, and Enterprise New Patient Services.',
  },
  {
    id: 5,
    name: 'Gloria Higuera',
    credentials: '',
    role: 'Senior Site Liaison, Enterprise New Patient Services',
